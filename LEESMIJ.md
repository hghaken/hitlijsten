...
| Handleiding | de complete gebruiksaanwijzing voor bezoekers als PDF in de huisstijl (`/static/handleiding.pdf`, link in de voetregel; bouwen met `python -m hitlijsten.handleiding`), met een eigen VirtualDJ-hoofdstuk |
