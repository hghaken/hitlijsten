...
- **Het hele archief staat in de database**: 572.141 noteringen over
  vierentwintig lijsten. Top 40
  ...
  Kink Top 1500 2019–2025 (7), de Veronica 80's 2005–2026 (19), De Foute 1500 2020–2026 (8 edities in 7 jaar) en de Q-Top 500 van de 10's 2014–2024 (8).
- 811 Excel-bestanden en 402 PDF-jaaroverzichten gebouwd, plus 687 aliassen,
  4.044 onderscheidingen, 5.704 doorverwijzingen van verhuisde sleutels en
  7.029 taalbepalingen. De 572.141 noteringen gaan over **35.863 nummers**
  van **13.814 artiesten**.
...
| Weeklijsten | één week zoals uitgezonden, met **vaste kolombreedtes** zodat de vier lijsten onder elkaar uitlijnen (alleen vanaf 761 pixels; op een telefoon zou een positiekolom van 8% de ring om het cijfer afsnijden), met week-keuzelijst, de extra keuze **Alle weeklijsten** (de vier onder elkaar, en sinds 22-08-2026 de **standaardkeuze** -- de menubalk linkt hierheen zonder parameters, zodat je ziet wat er die week te halen valt in plaats van meteen in de Top 40 te landen alsof de andere drie er niet zijn; elk **dichtgeklapt** in een `<details>` met de lijstnaam, het aantal noteringen en de nummer 1 in de samenvatting, maar **open zodra het NL- of nieuw-filter aanstaat**, want dan heb je net gezegd wat je zoekt -- vier volledige lijsten onder elkaar is te veel om doorheen te scrollen, en een rij kale lijstnamen zegt te weinig om op te klikken; bij een enkele lijst blijft de pagina onveranderd, zonder uitklapper; elk met eigen kop en posities; Excel krijgt dan een tab per lijst, de PDF de vier **doorlopend** onder elkaar — een nieuwe pagina alleen als het niet meer past, want met het nieuw-filter zijn vier hele pagina's voor zeventien binnenkomers verspilling — en de DJ Export één playlist met dubbelen eruit), bladeren over de jaargrens heen (een overgeslagen kerstweek wordt overgeslagen) en de nieuw/terug-spelden; het **nieuw-vinkje** betekent hier de binnenkomers van de wéék zelf (het groene speldje), niet de jaargang-binnenkomers |
...
| Vormgeving | menubalk in twee rijen (de lijsten boven, de extra's en het beheer gedempt eronder), doorschijnend over de banner en met blur zodra er gescrold is. De bovenste rij is sinds 22-08-2026 een **raster** en geen flexrij: met `flex-wrap` bepaalde de nav waar Handleiding/Disclaimer/Aanmelden/taal terechtkwamen, en die sprongen bij elke schermbreedte een andere kant op. Nu heeft die rechterkolom een vaste plek naast het merk; past de nav er niet meer naast (onder 1250px), dan zakt **alleen de nav** naar een tweede regel. De vier links zijn onderling ook een flexrij met `nowrap` — als inline tekst braken ze middenin af — en onder 760px worden ze kleiner zodat ze op een telefoon náást het merk passen; de rechterkolom is daarbij op **icoontjes** overgegaan (⚖️ disclaimer, 🔑 beheer / 🔓 afmelden, en de taalknop een **vlaggetje** — de vlag van de taal waar je naartoe gaat, als **SVG** en niet als emoji, want Windows tekent emoji-vlaggen als de kale letters NL en GB (dezelfde reden als bij `_vlag.html`); de Union Jack is vereenvoudigd, want op zestien pixels breed zie je de verspringing in de diagonalen toch niet. Alle met de naam in `title` en `aria-label`, en met padding eromheen: een raakvlak van twintig pixels is te klein voor een duim. **De handleiding houdt haar woord** zolang er ruimte is en wordt pas onder de 760px het boekje 📖 — van de vier is dat de enige die voor de bezoeker bedoeld is, en een icoontje zonder hover is op een telefoon niet te ontcijferen; beheer en de kleine lettertjes zoekt men gericht op. Het omslagpunt waarop de nav naar een tweede regel zakt kon mee omlaag van 1250 naar **1100** — gemeten nodig is 1055px (NL, mét dat woord) — dat is beheer en geen bezoekersfunctie, en het scheelt de zeventig pixels die op 320px net het verschil maakten. Breken ze toch een keer, dan lijnt de rij vanaf boven uit zodat het merk op de eerste regel blijft. Nagemeten op 320/375/762/1110/1400px in beide talen — overal één regel; tabellen tot 100 rijen krijgen hun volle hoogte (geen binnenste scrollbalk), daarboven een scrollvak van 78vh; onder de 760px compact en niet-plakkend |
